...
for line in lines:
    ...
    match code[0]:
        case 'R':
            lineList.append({'dir':DIR.R,'cross':False,'start':pos[0],'end':pos[0] + code[1], 'offset':pos[1]})
            pos[0] = pos[0]+code[1]
        case 'L':
            lineList.append( {'dir':DIR.L, 'cross':False,'start': pos[0] - code[1], 'end':pos[0], 'offset':pos[1]} )
            pos[0] = pos[0] - code[1]
        case 'U':
            lineList.append({'dir': DIR.U, 'cross':False,'start': pos[1] - code[1], 'end':pos[1], 'offset':pos[0]})
            pos[1] = pos[1] - code[1]
        case 'D':
            lineList.append({'dir': DIR.D, 'cross':False,'start': pos[1], 'end':pos[1] + code[1], 'offset':pos[0]})
            pos[1] = pos[1] + code[1]
